...
- [ ] 5.2 Disparar manualmente el workflow de deploy sobre la rama con `gh workflow run deploy.yml --ref chore/upgrade-astro-v7` y revisar en `gh run watch` que los pasos `npm ci` y `npm run build` terminan en verde con Node 24.
