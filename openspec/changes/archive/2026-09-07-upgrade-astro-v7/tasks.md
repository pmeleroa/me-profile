...
- [x] 5.3 Abrir el PR contra `main` con el resumen del upgrade; verificar que la descripción enlaza a este change de OpenSpec (`openspec/changes/upgrade-astro-v7/`). PR #15 (borrador): https://github.com/pmeleroa/me-profile/pull/15 — la descripción enlaza a `openspec/changes/upgrade-astro-v7/` e incluye el hallazgo del gate `check-commit` registrado en 5.2.
